...
export const commonBudgetRows: BudgetRow[] = [
  { item: '高速船（片道・鹿児島→屋久島）', amount: '14,000円', note: '✅ 3名分 42,000円 決済済み（7/30）', confidence: 'high' },
  ...
  { item: '宿泊3泊', amount: '約15,000円', note: '宮崎・鹿児島はAirbnb（概算）、屋久島は民宿たけすぎ 8,300円＝確定（2食付）', confidence: 'medium' },
  { item: '食事4日', amount: '約15,000円', note: '1日4,000〜6,000円。8/25 の夕食と 8/26 の朝食は宿代に含まれる', confidence: 'medium' },
  { item: '観光・協力金', amount: '約2,100円', note: '白谷雲水峡800／尾之間温泉300／駐車場ほか（ボートは不成立）', confidence: 'medium' },
]
...
export const budgetNote =
  'すべて「目安」です（3名で割り勘）。現地費用だけなら1人あたり約66,000円。4名想定より車関係が1人あたり2〜3割上がっています。8/23〜26 はお盆ピーク（8/10〜18頃）を外しているため、航空券・宿の大幅な上振れは回避できています。帰着は3人とも羽田22:15で、大阪・京都メンバーの関西への帰路は別途必要です。'
