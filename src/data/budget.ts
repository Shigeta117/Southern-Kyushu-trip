...
export const budgetNote =
  'すべて「目安」です（3名で割り勘）。現地費用だけなら1人あたり約66,000円。4名想定より車関係が1人あたり2〜3割上がっています。8/23〜26 はお盆ピーク（8/10〜18頃）を外しているため、航空券・宿の大幅な上振れは回避できています。帰着は3人とも羽田22:25で、大阪・京都メンバーの関西への帰路は別途必要です。'
