...
export const transportCards: TransportCard[] = [
  {
    ...
    notes: [
      ...
      '契約上の返却期限は 8/25 18:00。ゲート到着 18:40 から逆算すると綱渡りになるので 17:30 に前倒しで返す。早返しに不利はない。',
  ...
  },
  {
    ...
    rows: [
      ...
      { label: '車両航送', value: '4m未満1,700円 / 5m未満2,350円（運転手1名分の旅客運賃込）。8/25 は片道のみ＝車2,350＋旅客250×2＝2,850円' },
  ...
  },
  {
    ...
    rows: [
      { label: '便', value: '熊本 19:10 → 成田 21:00' },
      { label: '運賃', value: '3名 71,820円（諸費用込み・23,940円/人）' },
      { label: '空港入り', value: '16:20 着 → 17:30 返却 → 18:10 チェックイン完了 → 18:40 ゲート' },
