...
export const mapPoints: MapPoint[] = [
  ...
  { name: '白谷雲水峡', coord: { lat: 30.359, lng: 130.517 }, day: 3, order: 14 },
  { name: '宮之浦（泊）', coord: { lat: 30.4295, lng: 130.5748 }, day: 3, order: 15, kind: 'stay' },
  // Day 4 — 8/26(水) 屋久島一周 → 帰路
  { name: '永田いなか浜', coord: { lat: 30.3833, lng: 130.417 }, day: 4, order: 16 },
  ...
  { name: '尾之間温泉', coord: { lat: 30.2337, lng: 130.5364 }, day: 4, order: 20 },
  { name: '千尋の滝', coord: { lat: 30.2725, lng: 130.555 }, day: 4, order: 21 },
  { name: 'ヤクスギランド', coord: { lat: 30.2939, lng: 130.5814 }, day: 4, order: 22 },
